...
' Assurer que la page de connexion est complètement chargée
Browser("Google").Page("Sign in - Google Accounts").WaitProperty "visible", True, 10
...
' Assurer que la page de mot de passe est complètement chargée
Browser("Google").Page("Sign in - Google Accounts_2").WaitProperty "visible", True, 10
